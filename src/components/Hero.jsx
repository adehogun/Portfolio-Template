...
const Hero = () => {
  return (
    <div className='relative flex items-center justify-center'>
      ...
      <section className="relative flex flex-col sm:flex-row w-full h-screen mx-auto overflow-hidden">
        <div className="absolute inset-0 sm:top-[250px] top-[150px] lg:top-[150px] xl:top-[250px] max-w-7xl mx-auto flex flex-row items-start justify-between gap-3">
          ...
          <div className="text-center px-4 sm:px-6 md:px-8">
            <h1 className="text-white font-poppins text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl">
              Hi, there! <br />
              <span className="text-gray-400 font-bold">
                I'm Adewale
              </span>
            </h1>
            <div className="mt-6 sm:mt-10 text-center bg-red-500 py-2 px-4 rounded-lg">
        ...
        <div className="flex justify-center sm:justify-end items-center w-full px-4 sm:px-0">
          <img
            src={bigProfile}
            alt="myprofile"
